...
core.log("action", "[EHS=>NHS] Loading discord plugin")

--if not jeoijod then return end

if not http then core.log("error", "[EHS=>NHS] Network Connection error!") return end

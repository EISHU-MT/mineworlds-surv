...
minetest.register_on_player_receive_fields(function(player,formname,fields)
	if fields.clear then
		...
		core.close_formspec(name,"email:inbox")
	end
...
function email.send_mail(aname, ato, msg)
	...
	minetest.chat_send_player(to, minetest.colorize("#00FF00", "Mail from " .. minetest.colorize(GetColor(name) or "#92C5FC", GetName(name)) .. ": " .. msg))
